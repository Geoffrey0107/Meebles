...
public class MainActivity extends AppCompatActivity {
    ...
    public void startRealTimePlacementListener(int userId) {
        ...
        // Listen to all users ordered by population (score) descending
        db.collection("users")
                ...
                .addSnapshotListener((snapshots, e) -> {
                    ...
                    popDisplay.setText(userPopulation + "");
                });
    }
    ...
    public void createNewUser(int initialPopulation) {
        ...
        // Create user object and display it to userId Display
        userObj user = new userObj(userId, initialPopulation, "Player" + userId);
        TextView idDisplay = (TextView)findViewById(R.id.userIdDisplay);
