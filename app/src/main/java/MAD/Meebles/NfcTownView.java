...
public class NfcTownView extends AppCompatActivity {

    LineChart chart;
    private Place place;
    private userObj user;
    private TextView meebleCount;
    final String TAG = "TOWN";
    private int USERID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nfc_town_view);
        ...
        TextView townCapacity = findViewById(R.id.townCapacity);
        townCapacity.setText("Max Capacity: " + place.getCapacity());
